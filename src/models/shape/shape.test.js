...
const p = new Primitive('flip-y', 'union', 'circle', 0, 1, { x: 0, y: 0 });
...
const p1 = new Primitive('flip-x-and-y', 'union', 'square', 1.5, 2,
    { x: 10, y: 20 });
const p2 = new Primitive('flip-x', 'difference', 'circle', 0, 1,
    { x: 5, y: 5 });
